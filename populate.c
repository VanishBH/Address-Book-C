#include "contact.h"   // Include structure definitions

// Dummy contact data (sample contacts)
...
// These are predefined contacts stored in array

void populateAddressBook(AddressBook* addressBook)
{
    // Find how many dummy contacts are there
    int numDummyContacts = sizeof(dummyContacts) / sizeof(dummyContacts[0]);

    // Copy dummy contacts into address book
